    ...
    draw(){
        if(this.shader) {
          ...
          gl.vertexAttribPointer(this.shader.nAttrib, this.mesh.normalBuffer.itemSize, gl.FLOAT, false, 0, 0);
           ...
           //Envoie la couleur de la tache de speculaire (bas� sur la couleur de la lumiere et sur KS ) 
         ...
         //Envoie la couleur de l'objet (bas� sur la couleur du materiau, de la lumiere et KD)
